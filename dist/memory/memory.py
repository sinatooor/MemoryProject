...
class GameScreen(Screen):
    ...
    def last_cell_check(self):
        ...
        if self.count_the_matchs == len(self.words) / 2:
            ...
            Player.maker(StartScreen.player_name, GameScreen.score, StartScreen.words_amount)
...
class ScoreScreen(Screen):
    ...
    def arrange_scores(self):
        ...
        self.manager.get_screen("score").ids.title.text = f"TOP 10 Scoreboard for {StartScreen.words_amount} words"
...
class Player:
    ...
    def top_10(cls, p_list,words_amount):
        ...
        indata: list of players and words_amount"""
